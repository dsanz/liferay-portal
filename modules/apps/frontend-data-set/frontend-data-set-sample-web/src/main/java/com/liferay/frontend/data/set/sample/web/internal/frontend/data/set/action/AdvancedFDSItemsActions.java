...
public class AdvancedFDSItemsActions implements FDSItemsActions {
	...
	public List<FDSActionDropdownItem> getFDSActionDropdownItems(
		...
		FDSActionDropdownItem fdsActionDropdownItem0 =
			new FDSActionDropdownItem("root", "Root", true, "contextual");

		fdsActionDropdownItem0.setFDSActionDropdownItems(
			Arrays.asList(
				new FDSActionDropdownItem(
				...
				new FDSActionDropdownItem(
					null, "reload", "reload", "Reload Data", null, null,
					"link"),
				new FDSActionDropdownItem(
					null, "rectangle-split", "openSidePanel", "Open Side Panel",
					null, null, "link")));

		return Arrays.asList(fdsActionDropdownItem0, fdsActionDropdownItem1);
	}
