...
public class CustomFDSViewSerializerImpl
	extends BaseCustomFDSSerializer implements FDSViewSerializer {
	...
	public JSONArray serialize(
		...
		try {
			jsonArray = _getFDSViewsJSONArray(
				...
				getDataSetCardSectionObjectEntries(fdsName, httpServletRequest),
				String.valueOf(properties.get("defaultVisualizationMode")),
				getDataSetTableSectionObjectEntries(
					fdsName, httpServletRequest),
				getDataSetListSectionObjectEntries(fdsName, httpServletRequest),
				httpServletRequest);
		}
