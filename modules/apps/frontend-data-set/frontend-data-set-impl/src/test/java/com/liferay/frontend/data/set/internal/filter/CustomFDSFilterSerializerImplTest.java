...
import com.liferay.frontend.data.set.internal.action.CustomFDSItemActionListSerializerImpl;
...
public class CustomFDSFilterSerializerImplTest {
	...
	public void setUp() throws Exception {
		ReflectionTestUtil.setFieldValue(
			...
			"_customFDSSerializerHelper", _customFDSSerializerHelper);
	}
	...
	private static final CustomFDSItemActionListSerializerImpl
		_customFDSItemActionListSerializerImpl =
			new CustomFDSItemActionListSerializerImpl();
	private static final CustomFDSSerializerHelper _customFDSSerializerHelper =
		Mockito.mock(CustomFDSSerializerHelper.class);
