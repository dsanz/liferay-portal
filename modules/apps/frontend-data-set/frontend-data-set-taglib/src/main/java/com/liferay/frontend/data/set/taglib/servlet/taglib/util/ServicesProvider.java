...
public class ServicesProvider {
	...
	public static FDSEntryRenderer getFDSEntryRenderer() {
		return _fdsEntryRendererSnapshot.get();
	}
	...
	private static final Snapshot<FDSEntryRenderer> _fdsEntryRendererSnapshot =
		new Snapshot<>(ServicesProvider.class, FDSEntryRenderer.class);
