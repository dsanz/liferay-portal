...
package com.liferay.frontend.data.set.views.web.internal.info.item.capability;
 ...
 */
@Component(
	property = "info.item.capability.key=" + RESTEndpointInfoItemCapability.KEY,
	service = InfoItemCapability.class
)
public class RESTEndpointInfoItemCapabilityImpl
	implements RESTEndpointInfoItemCapability {
	...
	public String getLabel(Locale locale) {
		return "rest-endpoint-capability";
	}
