...
@Component(
	...
	property = {
		...
		"mvc.command.name=/",
		"mvc.command.name=/message_boards_subscription_manager/view"
	},
	service = MVCRenderCommand.class
)
public class MBSubscriptionManagerViewMVCRenderCommand
	...
	public String render(
		...
		return "/message_boards_subscription_manager/view.jsp";
	}
