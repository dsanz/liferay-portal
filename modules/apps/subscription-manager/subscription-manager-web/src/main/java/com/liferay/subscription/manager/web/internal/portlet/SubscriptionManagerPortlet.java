...
@Component(
	immediate = true,
	property = {
		"com.liferay.portlet.css-class-wrapper=portlet-subscription-manager",
		"com.liferay.portlet.display-category=category.collaboration",
		"com.liferay.portlet.icon=/subscription_manager/icons/subscription_manager.png",
		...
		"javax.portlet.display-name=Subscription Manager",
		"javax.portlet.expiration-cache=0",
		"javax.portlet.init-param.mvc-command-names-default-views=/subscription_manager/view",
