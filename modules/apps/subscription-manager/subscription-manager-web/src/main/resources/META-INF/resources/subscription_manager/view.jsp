	...
	>
		...
		>
			...
			<liferay-ui:search-container-column-jsp
				align="right"
				path="/subscription_manager/category_action.jsp"
			/>
		</liferay-ui:search-container-row>
...
private String _getSubscribers(PageContext pageContext, MBCategory mbCategory) throws Exception {
	...
	PortletURL portletURL = PortletURLFactoryUtil.create(request, SubscriptionManagerPortletKeys.SUBSCRIPTION_MANAGER, themeDisplay.getPlid(), PortletRequest.RENDER_PHASE);

	portletURL.setParameter("mvcRenderCommandName", "/subscription_manager/edit_subscriptions");
